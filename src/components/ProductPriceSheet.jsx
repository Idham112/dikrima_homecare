...
function ProductPriceSheet({ open, setOpen, product }) {
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent className=" w-3/4 h-6/7 overflow-y-auto bg-white">
        <div className="px-2 pt-10 pb-20 flex flex-col gap-6">
          <div className="ml-2">
            ...
            <div>
              ...
              {/* cards */}
              <div className="grid grid-cols-2 grid-rows-[repeat(auto-fit,minmax(200px,1fr))]">
